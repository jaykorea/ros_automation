...
terminator --new-tab -T "init" -e "zsh -c  \"sleep 2s;roslaunch fw_rev_04_init fw_robot.launch;exec zsh\"" &
...
terminator --new-tab -T "slam" -e "zsh -c \"sleep 5s;roslaunch fw_rev_04_rtabmap fw_navigation_stereo_test2_jay_2dlidar.launch rviz:=true;exec zsh\"" &
