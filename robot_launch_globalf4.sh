...
--tab --title="slam" -e "zsh -c \"source /home/fw/.zshrc;sleep 5s;roslaunch fw_rev_04_rtabmap fw_navigation_stereo_test2_jay_2dlidar.launch rviz:=false database_path:=~/.ros/globalf4.db;exec zsh\"" \
